...
- Changelog or release: `cliff.toml`, `scripts/changelog.ts`, `scripts/lib/changelog.ts`, `scripts/lib/release-version.ts`, `scripts/check-versions.ts`, `scripts/release/pack-npm.ts`, `packages/cli/`, `.github/workflows/{pr-qa-gate,release}.yml`, `docs/reference/releasing.md`
