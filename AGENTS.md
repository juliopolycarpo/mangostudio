...
- Tools: `apps/api/src/services/tools/registry.ts`, `apps/api/src/services/tools/builtin/generate-image.ts`, `apps/api/src/services/tools/builtin/ask-user-question.ts`, `apps/shared/src/questions/`, `apps/frontend/src/features/chat/components/QuestionCard.tsx`, `apps/api/src/modules/tool-settings/http/tool-settings-routes.ts`, `apps/frontend/src/features/settings/tools/index.tsx`
