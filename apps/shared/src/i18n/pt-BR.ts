export const messages = {
  ...
  settings: {
    ...
    connectors: {
      ...
      deleteError: 'Falha ao excluir conector',
      updateModelsError: 'Falha ao atualizar modelos',
    ...
    appearance: {
      ...
      fontPreview: 'A rápida raposa marrom pula sobre o cachorro preguiçoso.',
      codeTheme: {
  ...
  errors: {
    ...
    imageGenerationFailed: 'Falha ao gerar a imagem. Tente novamente.',
    galleryLoadFailed: 'Falha ao carregar os itens da galeria',
  },
  ...
  marketplace: {
    ...
    apply: 'Aplicar',
    info: 'Info',
    addFromMarketplace: 'Adicionar do Marketplace',
    installYourOwn: 'Instalar seu próprio',
    dark: 'Escuro',
    light: 'Claro',
    builtIn: 'Incluso',
    suggested: 'Sugerido',
