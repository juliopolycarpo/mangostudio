...
AI-powered image generation and chat studio using Google's Gemini models.
...
3. **.env file** — Adds variables to the `.env` file at the project root.
...
| **AI**       | Google Gemini API — text and image generation                  |
